...
In Figure \@ref(fig:ct-schools), you have a chart of the reported number of Covid19 cases among Connecticut school children, as provided by the state. Numbers are broken down by 'learning model', that is, whether the reported cases for children engaged in remote learning, fully in-person learning, or some hybrid model. 

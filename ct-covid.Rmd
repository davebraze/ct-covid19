...
I started putting together graphs based on Connecticut Department of Public Health (DPH) data in late March, and I've been putting graphs up on various social media platforms since the first week of April. If you're interested in what those earlier efforts looked like, you can find some of them on Twitter at 
[https://twitter.com/search?q=%23Connecticut%20%23covid19%20%40davidbraze&src=typed_query](https://twitter.com/search?q=%23Connecticut%20%23covid19%20%40davidbraze&src=typed_query). You could also [follow me on twitter](https://twitter.com/davidbraze).
...
Most of my time in my day job is spent working with research and data focused on the topics of education, language, and literacy. I am a freelance consultant for hire. My website and blog can be found at [davebraze.org](https://davebraze.org/).
...
Connecticut DPH provides its most comprehensive set of statistics at the state level. As of April 1, there are four basic statistics available. These are: Number of Covid-19 ***tests completed***; Number of ***confirmed cases*** of Covid19; Number of Covid-19 related ***Deaths***; Number of Covid-19 ***Hospitalizations***. The first three statistics are all cumulative counts. In other words, each represents the total number since record keeping began. So, those numbers can only go up from one day to the next, or stay the same. On the other hand, ***Hospitalizations*** is the number of people in the hospital on a given day. That statistic can go up or down from one day to the next. For two of those statistics, ***confirmed cases*** and ***deaths***, the state also gives the breakdown by Age, Gender, and Race. But, there are no cross-tabulations provided. 

Only three of those statistics are available at the county level, ***tests completed*** is not. Only two statistics available at the town level, ***hospitalizations*** is not. Age, Gender, and Race breakdowns are not available for any statistic for county and town level data.

...
It's also interesting to look at how Connecticut is doing relative to other states. Figure \@ref(fig:usa-state-corona) shows the growth in cumulative Covid-19 cases for all 50 states. Connecticut, shown in blue, is consistently between 9th and 12th place for number of cases. So, Connecticut is really outperforming, not in a good way , considering it is only the 29th most populous state.

...
The map in Figure \@ref(fig:map-cumcases) shows the total cumulative number of COVID19 cases for every town in Connecticut over the entire span of the pandemic to date. The numbers shown for each town in the map correspond to the endpoints of the lines in Figures \@ref(fig:town-rate), \@ref(fig:town-by-county-rate), and \@ref(fig:town-by-pop-rate).

...
The map files used in Figure \@ref(fig:map-today) were downloaded from the [Map and Geographic Information Center at the UConn Library](http://magic.lib.uconn.edu/).
...
The map in Figure \@ref(fig:map-today) shows the total cumulative number of COVID19 cases for every town in Connecticut over the entire span of the pandemic to date. The numbers shown for each town in the map correspond to the endpoints of the lines in Figures \@ref(fig:town-rate), \@ref(fig:town-by-county-rate), and \@ref(fig:town-by-pop-rate).

```{r map-today, fig.height=7, fig.cap="Cumulative Covid-19 cases by town."}

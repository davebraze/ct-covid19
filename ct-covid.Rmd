...
**Figure \@ref(fig:map-positivity) is interactive.** Hover over the positivity number for any town to see more details. You can also zoom by clicking and dragging to select the area you want to zoom. Undo the zoom by double clicking anywhere on the map. None of this is very usable on small screens (phones!); it's best viewed on a larger tablet or computer. (Tests/10k/day is the number of tests performed in the town each day for each 10,000 population.)
